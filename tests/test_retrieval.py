...
import pytest
from backend.model_config import RERANKER_MODEL, TOKEN_BUDGETS
...
def test_conversation_mmr_prefers_diverse_candidates_deterministically() -> None:
    ...
    results = retrieve(collection, "question", [0.3, 0.7], "conversations")
...
def test_conversation_mmr_breaks_exact_ties_by_candidate_order() -> None:
    collection = FakeCollection(
        [
